      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in-up">
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
            What Campus Venture Does
          </h2>
          <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
            Campus Venture connects ambitious student founders with supportive campus communities. We make it easy for students, faculty, and alumni to invest small amounts into verified student startups—giving founders the funding and visibility they need to succeed.
          </p>
        </div>
